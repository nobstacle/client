  ...
  return (
    ...
    >
      ...
      {userData?.user.Roles?.includes("Admin") && (
        <Modal title="Create scroll template" closeModal={handleClose} isOpen={isOpen}>
      ...
      <div id="card-wrapper" className="flex h-full w-full">
        <div className="flex w-full flex-wrap content-start gap-4">
          ...
          {editTemplate && (
            <Modal title="Update scroll template" closeModal={updateHandleClose} isOpen={updateIsOpen}>
