...
import { useUserControllerCreate } from "../../lib/nobstacle-api-client/react-query/users/users"
import { usePersistedAuthStore } from "../../lib/nobstacle-api-client/zustand"
import { useAuthControllerLogin } from "../../lib/nobstacle-api-client/react-query/auth/auth"
          ...
          },
          {
            onSuccess: () => {
              login.mutate(
                {
                  data: {
                    emailOrUsername: formInputs.email,
                    password: formInputs.password
                  }
                },
                {
